...
// Get the user's information from the admins table
$user_id = $_SESSION['user_id'];
$sql_user = "SELECT username, job FROM admins WHERE admin_id = ?";
$stmt_user = $conn->prepare($sql_user);
$stmt_user->bind_param("i", $user_id);
$stmt_user->execute();
$stmt_user->bind_result($username, $job);
$stmt_user->fetch();
$stmt_user->close();
...
<head>
    ...
    <title>KOSTGAS - Landlord Profile</title>
    <style>
        body {
    ...
    <div class="container">
        <div class="profile-section">
            ...
            <div class="info">
                ...
                <div>
                    <input type="text" value="<?php echo htmlspecialchars($job); ?>" readonly>
                </div>
                <div>
                    <button onclick="window.location.href='landlord_dashboard.php'">BACK TO HOMEPAGE</button>
                </div>
            </div>
        </div>
